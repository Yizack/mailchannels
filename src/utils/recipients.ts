import type { SendRecipient } from "../types/emails/send";
 ...
 */
export const parseRecipient = (recipient?: SendRecipient | string) => {
 ...
 */
export const parseArrayRecipients = (recipients?: SendRecipient | SendRecipient[] | string[] | string) => {
